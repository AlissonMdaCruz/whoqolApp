const questions: any = [{
  "info": "Por favor, leia cada questão, veja o que você acha e selecione o que lhe parecer a melhor resposta.",
...
{
  "info": "As questões seguintes referem-se a com que frequência você sentiu ou experimentou certas coisas nas últimas duas semanas.",
  "questao": "26. Com que frequência você tem sentimentos negativos tais como mau humor, desespero, ansiedade, depressão?",
